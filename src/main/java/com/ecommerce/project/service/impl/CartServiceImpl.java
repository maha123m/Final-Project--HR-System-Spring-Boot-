...
public class CartServiceImpl implements CartService {
    ...
    @Override
    public CartDTO addProductToCart(Long id, Integer quantity) {

        // find existence cart or create one
        ...
        CartItem cartItem = cartItemRepository.findCartItemByProductIdAndCartId(cart.getId(), id);
